...
// Get Product model
var Product = require('../models/valentine');
 ...
 * GET add product
 */
router.get('/add-valentine',isAdmin,  function (req, res) {
    ...
    Category.find(function (err, categories) {
        res.render('admin/add_valentine', {
            title: title,
            desc: desc,
 ...
 * POST add product
 */
router.post('/add-valentine', function (req, res) {
 ...
 * GET edit product
 */
router.get('/edit-valentine/:id', isAdmin,  function (req, res) {
            ...
            if (err) {
                ...
                fs.readdir(galleryDir, function (err, files) {
                    if (err) {
                        ...
                        res.render('admin/edit_valentine', {
                            title: p.title,
                            errors: errors,
                            seller:p.seller,
                            discount:p.discount,
 ...
 * POST edit product
 */
router.post('/edit-valentine/:id', function (req, res) {
 ...
 * GET delete product
 */
router.get('/delete-valentine/:id', isAdmin, function (req, res) {
